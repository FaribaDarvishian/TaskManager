...
public class UserDBRoomRepository {
    ...
    public static Long checkUserExist(com.example.taskmanager.repository.UserDBRoomRepository userDBRoomRepository, String username, String password) {
    ...
    public static Long checkUserExist(com.example.taskmanager.repository.UserDBRoomRepository userDBRoomRepository, String username) {
        for (User user : userDBRoomRepository.getList()) {
